...
import org.adamsmith.io.ReadBinaryScoreMapsStream;
import org.adamsmith.io.WriteBinaryScoreGroupStream;
import org.adamsmith.stage1.HandRecord;
import org.adamsmith.stage1.HandRecordScoreMap;
import org.adamsmith.stage2.Touple.ToupleFloatComparator;
import org.adamsmith.stage2.Touple.ToupleFloatInt;
import org.adamsmith.stage2.Touple.ToupleIntComparator;
import org.adamsmith.game.Card;
...
public class DoClusteringStep1 {
	...
	private static final String ROOT_INPUT_DIR = Constants.DATA_FILE_REPOSITORY +
			"org/adamsmith/stage1" + Constants.dirSep;
	
	private static final String ROOT_OUTPUT_DIR = Constants.DATA_FILE_REPOSITORY +
			"org/adamsmith/stage2" + Constants.dirSep;
